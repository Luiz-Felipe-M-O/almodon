...
A documentação do Almodon está disponível no [Manual do Desenvolvedor](./docs/DEVELOPER.md). Lá é encontrado informações detalhadas sobre a arquitetura do sistema, instruções de instalação, guias de contribuição e muito mais.
